...
import arhangel.dim.core.store.MessageDaoStore;
...
import arhangel.dim.core.store.UserDaoStore;
...
public class Session implements ConnectionHandler, Runnable {
    ...
    private MessageDaoStore messageDao;
    ...
    public Session(Socket socket, Server server) throws IOException {
        ...
        userDao = new UserDaoStore();
        messageDao = new MessageDaoStore();
    }
            ...
            switch (msg.getType()) {
                case MSG_LOGIN:
                    ...
                    if (founduser == null) {
                        ...
                        statusMessage = new StatusMessage("User " + newuser.getName() + " was created");
                        statusMessage.setType(Type.MSG_STATUS);
                        send(statusMessage);
                        break;
                    } else if (founduser.getPassword() == null) {
                        statusMessage = new StatusMessage("Wrong password for " + founduser.getName());
                        statusMessage.setType(Type.MSG_STATUS);
                        send(statusMessage);
                        break;
                    }
                ...
                case MSG_CHAT_CREATE:
                    ...
                    StatusMessage chatWasCreated = new StatusMessage(
                            "Chat with id = " + createdChatId + " was created"
                    );
                ...
                case MSG_INFO:
                    ...
                    InfoResultMessage infoResultMessage = new InfoResultMessage(
                            infoUser.getId(),infoUser.getName(), infoUser.getPassword(), ""
                    );
